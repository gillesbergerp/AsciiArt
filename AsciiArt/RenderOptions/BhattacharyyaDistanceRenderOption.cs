...
{
    /// <summary>
    /// Calculates an ASCII art image's characters using Bhattacharyya distance distance. See <see cref="Histogram.BhattacharyyaDistance(Histogram)"/> for more information.
    /// </summary>
    public class BhattacharyyaDistanceRenderOption : RenderOption
    {
        /// <summary>
        ...
        /// <summary>
        /// Calculates the best-fitting character based on the Bhattacharyya distance between the character's and tile's histograms. See <see cref="RenderOption.CalculateCharForMatrix(PixelMatrix)"/> and <see cref="Histogram.BhattacharyyaDistance(Histogram)"/> for more information.
        /// </summary>
        ...
        public override KeyValuePair<char, PixelMatrix> CalculateCharForMatrix(PixelMatrix tile)
        {
            ...
            {
                double score = tile.Histogram.BhattacharyyaDistance(item.Value.Histogram);
