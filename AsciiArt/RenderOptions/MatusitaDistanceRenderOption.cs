...
{
    /// <summary>
    /// Calculates an ASCII art image's characters using Matusita distance distance. See <see cref="Histogram.MatusitaDistance(Histogram)"/> for more information.
    /// </summary>
    public class MatusitaDistanceRenderOption : RenderOption
    {
        /// <summary>
        ...
        /// <summary>
        /// Calculates the best-fitting character based on Matusita distance between the character's and tile's histograms. See <see cref="RenderOption.CalculateCharForMatrix(PixelMatrix)"/> and <see cref="Histogram.MatusitaDistance(Histogram)"/> for more information.
        /// </summary>
        ...
        public override KeyValuePair<char, PixelMatrix> CalculateCharForMatrix(PixelMatrix tile)
        {
            ...
            {
                double score = tile.Histogram.MatusitaDistance(item.Value.Histogram);
